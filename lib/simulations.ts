    ...
    variants: {
      automation: {
        ...
        insights: [
          ...
          { type: 'prediction', icon: '📊', title: 'Predicción de saturación', description: 'El modelo proyecta que C-05 (Centro) alcanzará el 85% en 30 días al ritmo de crecimiento actual. Upgrade preventivo programado.' },
          { type: 'recommendation', icon: '💡', title: 'Retención proactiva activada', description: 'La IA identificó 1,240 clientes en zona norte con 2+ tickets y consumo decreciente (churn 6%). Campaña de retención automática enviada.' },
        ],
        impacts: [
          { label: 'Tickets que requieren agente humano', before: '12K/semana', after: '5.4K/semana', unit: '' },
          { label: 'Tiempo de resolución promedio', before: '48 horas', after: '2.5 horas', unit: '' },
      ...
      agency: {
        ...
        panelIntro: 'El agente gestiona soporte, retención y coordinación con el área técnica de forma autónoma, 24/7.',
        insights: [
          { type: 'automation', icon: '🤖', title: 'Agente atendió 8,420 interacciones hoy', description: 'WhatsApp, app y web. Resolución sin derivar: 88%. Diagnosticó las fallas de la zona norte y abrió 3 órdenes de trabajo al área técnica automáticamente.' },
      ...
      augmentation: {
        actionLabel: '🧠 Asistir al jefe de operaciones de red',
        processingMessage: 'La IA está preparando el análisis de red y los escenarios de inversión para el equipo...',
        panelTitle: 'Copiloto de Operaciones de Red',
        panelIntro: 'La IA amplifica el criterio del equipo de red con análisis de tráfico, causa raíz y simulación de inversiones — la decisión es humana.',
        insights: [
          { type: 'insight', icon: '🔍', title: 'Causa raíz de la congestión norte', description: 'El crecimiento de usuarios en la zona norte (3 años de infraestructura) superó la capacidad del nodo. El 78% de los tickets de la zona se concentran en hora pico.' },
          { type: 'prediction', icon: '📊', title: 'Simulación: 3 planes de inversión', description: 'A) Ampliar N-01 ($180K, resuelve 18 meses). B) Nueva celda norte ($420K, resuelve 4 años). C) Balanceo y diferir (riesgo de churn). ROI por escenario.' },
          { type: 'recommendation', icon: '💡', title: 'Priorización de retención', description: 'De los clientes en riesgo, el copiloto sugiere enfocar la retención en los 340 de mayor valor (LTV alto). El jefe decide el presupuesto de retención.' },
          { type: 'alert', icon: '⚠️', title: 'Patrón de fallas detectado', description: 'Las caídas se correlacionan con temperatura > 32°C en 2 sitios sin climatización adecuada. Revisar antes de la próxima ola de calor.' },
        ],
        impacts: [
          { label: 'Tiempo del equipo en análisis de red', before: '4 h/día', after: '40 min/día', unit: '' },
          { label: 'Precisión en planificación de capacidad', before: '72%', after: '93%', unit: '' },
          { label: 'CSAT (satisfacción del cliente)', before: '6.2/10', after: '8.4/10', unit: '' },
        ],
      },
    },
  },
