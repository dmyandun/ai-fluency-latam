const INDUSTRY_CASES: Record<string, string[]> = {
  manufacturing: [
    ...
    'Nuestra línea de ensamblaje produce 1,200 unidades/día con una tasa de defectos del 4.2%, por encima del objetivo del 1.5%. Hoy inspeccionamos por muestreo (1 de cada 20 unidades) y los defectos se concentran en el turno nocturno y en 2 de 8 estaciones. El reproceso cuesta $18K/mes. ¿Conviene pasar a inspección visual del 100% con IA y cómo priorizarías la mejora?',
    'Tenemos 3 plantas con OEE (eficiencia general) de 58%, 71% y 64%. La planta de 58% tiene paros frecuentes no planificados (cada hora de paro cuesta ~$8K) y mantenimiento reactivo. El presupuesto de mantenimiento es $400K/año. ¿Cómo abordarías el problema y dónde entraría IA predictiva?',
  ],
  banking: [
  ...
  health: [
    ...
    'Nuestros 45 médicos dedican 1-2 horas extra al día a documentar consultas en la historia clínica electrónica, y la codificación de diagnósticos (ICD-10) toma 10-15 minutos por alta con errores que cuestan ~$3,200 por caso mal codificado. El equipo de codificación (4 personas) está saturado y el burnout va en aumento. ¿Cómo reducirías la carga documental y de codificación, y dónde entraría la IA?',
  ],
  logistics: [
    ...
    'Nuestra flota de 25 camiones tiene un costo de combustible de $48K/mes y un 22% de kilómetros en vacío (sin carga); estimamos 10-12 km extra por conductor al día por rutas subóptimas. Las rutas se planifican manualmente cada mañana. El cumplimiento de ventanas horarias es del 81%. ¿Cómo optimizarías rutas y reducirías kilómetros muertos?',
    'Operamos un centro de distribución que despacha 3,500 pedidos/día. El tiempo de picking promedio es 14 min/pedido, con congestión en 2 pasillos que concentran el 40% del volumen y SKUs muy heterogéneos (de sobres a cajas de 20 kg) que complican automatizar. El error de despacho es 1.8%. ¿Qué analizarías para acelerar el fulfillment y qué automatizarías?',
  ],
  legal: [
