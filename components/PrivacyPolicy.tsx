      ...
      <main className="flex-1 px-6 py-16 w-full">
        <article className="max-w-3xl mx-auto">
          <header className="mb-12">
            <span className="inline-flex items-center gap-2 bg-blue-50 border border-blue-200 text-blue-600 text-xs font-medium px-3 py-1.5 rounded-full mb-6">
              Transparencia y privacidad
            </span>
            <h1 className="text-3xl sm:text-4xl font-semibold text-slate-900 leading-tight tracking-tight mb-4">
              Política de Privacidad
            </h1>
            <p className="text-slate-600">
              Fecha de vigencia: <span className="text-slate-700">{EFFECTIVE_DATE}</span>
            </p>
          </header>
          ...
          <div className="space-y-12 text-slate-700 leading-relaxed">
            ...
            {/* 1 */}
            <section>
              <h2 className="text-xl font-semibold text-slate-900 mb-4">1. Quiénes somos</h2>
              <p className="mb-3">
              ...
              <p>
                ...
                <strong className="text-slate-900">Daniel Yandun</strong>. Para cualquier consulta sobre
            ...
            {/* 2 */}
            <section>
              <h2 className="text-xl font-semibold text-slate-900 mb-4">2. Qué información recopilamos</h2>
              <p className="mb-4">
                ...
                <strong className="text-slate-900">no se envía ningún dato a servidores propios.</strong>
              </p>
              ...
              <p className="mb-3">
                ...
                el almacenamiento local (<code className="text-blue-700">localStorage</code>) de tu
                navegador, en tu propio dispositivo:
              </p>
              <ul className="list-disc list-inside space-y-2 mb-4 text-slate-600">
                <li>
                  <code className="text-blue-700">afl_result</code>: tus respuestas a las preguntas
                  del diagnóstico (sobre el contexto de tu organización) y los puntajes calculados a
                  partir de ellas.
                </li>
                <li>
                  <code className="text-blue-700">afl_roadmap</code>: el roadmap generado para ti,
                  incluyendo cualquier edición que realices sobre él.
                </li>
              </ul>
              <p className="mb-4 text-slate-600">
                Estos datos <strong className="text-slate-900">nunca salen de tu dispositivo</strong>: no
              ...
              <p className="mb-4 text-slate-600">
                La aplicación <strong className="text-slate-900">no solicita ni recopila</strong> nombre,
              ...
              <h3 className="text-base font-semibold text-slate-900 mb-2">Datos técnicos</h3>
              <p className="text-slate-600">
            ...
            {/* 3 */}
            <section>
              <h2 className="text-xl font-semibold text-slate-900 mb-4">3. Cómo usamos la información</h2>
              <p className="mb-3">
            ...
            {/* 4 */}
            <section>
              <h2 className="text-xl font-semibold text-slate-900 mb-4">4. Almacenamiento y seguridad</h2>
              <ul className="list-disc list-inside space-y-2 text-slate-600">
                <li>
                  <strong className="text-slate-900">Dónde viven los datos:</strong> exclusivamente en el
                  almacenamiento local de tu navegador, en tu dispositivo.
                </li>
                <li>
                  <strong className="text-slate-900">Por cuánto tiempo:</strong> permanecen hasta que tú
                  los elimines (borrando los datos del sitio en tu navegador) o reinicies el
                  diagnóstico.
                </li>
                <li>
                  <strong className="text-slate-900">Cómo se protegen:</strong> al no transmitirse a
            ...
            <section>
              ...
              <p className="mb-3 text-slate-600">
                ...
                ARCO: <strong className="text-slate-900">Acceso, Rectificación, Cancelación y Oposición</strong>.
              ...
              <ul className="list-disc list-inside space-y-2 mb-4 text-slate-600">
                <li>
                  <strong className="text-slate-900">Acceso:</strong> tus datos son visibles en la página
                  de resultados; también puedes inspeccionar el{' '}
                  <code className="text-blue-700">localStorage</code> desde las herramientas de tu
                  navegador.
                </li>
                <li>
                  <strong className="text-slate-900">Rectificación:</strong> puedes editar tu roadmap o
                  repetir el diagnóstico en cualquier momento.
                </li>
                <li>
                  <strong className="text-slate-900">Cancelación (supresión):</strong> borra los datos
                  del sitio en tu navegador para eliminar por completo la información almacenada.
                </li>
                <li>
                  <strong className="text-slate-900">Oposición:</strong> deja de usar la herramienta; no
            ...
            <section>
              ...
              <p className="mb-3 text-slate-600">
                AI Fluency LATAM{' '}
                <strong className="text-slate-900">no utiliza cookies de seguimiento ni de publicidad</strong>,
                y no emplea herramientas de analítica de terceros.
              </p>
              <p className="text-slate-600">
                La aplicación usa el almacenamiento local del navegador (
                <code className="text-blue-700">localStorage</code>), que es una tecnología
